    ...
    <div class="row">
      <div class="col-sm">
        <div class="alert alert-secondary mb-3 mt-0 rrc" style="text-align: center; background-color: #F7F8F9">
          ...
          <div class="alert alert-danger rrc" style="padding-bottom: 0">
      ...
      <div class="col-sm  pl-1">
        <JsonTree class="json-tree-root rrc" :data="dataObj"></JsonTree>
        <button class="btn btn-outline-dark rrc" style="width: 100%; margin-top: 15px"
